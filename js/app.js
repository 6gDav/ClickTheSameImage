...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const allButtonEl = Array.from(allButtonElUnFiltered).filter(button => { var _a, _b; return ((_a = button.textContent) === null || _a === void 0 ? void 0 : _a.trim()) !== "Start" && ((_b = button.textContent) === null || _b === void 0 ? void 0 : _b.trim()) !== "Code here"; });
